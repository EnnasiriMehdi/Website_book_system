...
{
    $key = new landing_fee($_POST["id"],"",1,"","","","");
    $ressources = [];
...
if (isset($_POST["change_state"]) && isset($_POST["id"]) && count($_POST)==2)
{
    ...
    $key = new landing_fee($_POST["id"],"",1,"","","",$state);
...
if (isset($_POST["delete_ressource"]) && isset($_POST["id"]) && count($_POST)==2)
{
    ...
    $key = new landing_fee($_POST["id"],"","50","","","","");
...
if (isset($_POST["modif_ressources"]) && isset($_POST["id"]) && count($_POST)==2)
{
    ...
    $key = new landing_fee($_POST["id"],$values[0],$values[1],$values[2],$values[3],$values[4],"1");
...
if (isset($_POST["create_ressources"]) && count($_POST)==1)
{
    ...
    $key = new landing_fee("",$values[0],$values[1],$values[2],$values[3],$values[4],0);
    echo $key ->create();
...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <div>
        <h1 class="h3 mb-4 text-gray-800 left_block">Redevance d'atterissage</h1><div class="right_block col-10"> <button class="button" onclick="show_create_block()">Créer une redevance</button></div>
    </div>
    ...
    <div>
        <div class="left_block col-6">
            <div>
                ...
                if (!empty($get_list))
                {
                    ...
                    foreach ($get_list as $res)
                    {
                        ...
                        echo                '<td>' . $res["week"] . '</td>';
                        echo                '<td id="state_'. $res["id"] .'">' . $res["id_plane_type"] . '</td>';
                        echo            '<tr>';
                    }
                    echo            '</tbody>';
                    echo        '</table>';
            ...
            <div>
                ...
                <div class="col-4 right_block text-center">
                    <button class="ressources_button_bis alert-warning" id="un_activate" disabled>Activer/Désactiver</button>
                </div>
            </div>
        ...
        <div class="right_block col-6 half-ressources" id="info_block">
            ...
            <div class="ressources_right_block">Basé :<p class = "display_infos right_block"></p></div>
            <div class="ressources_right_block">Semaine :<p class = "display_infos right_block"></p></div>
            <div class="ressources_right_block">Type d'appareils :<p class = "display_infos right_block"></p></div>
        ...
        <div class="right_block col-6 half-ressources" id="modif_block">
            ...
            <div class="ressources_right_block">Basé :<input type="text" step="0.01"class="new_ressources right_block"></div>
            <div class="ressources_right_block">Semaine :<input type="text" step="0.01"class="new_ressources right_block"></div>
            <div class="ressources_right_block">Type d'appareils :<input type="text" step="0.01"class="new_ressources right_block"></div>
        ...
        <div class="right_block col-6 half-ressources" id="create_block">
            ...
            <div class="ressources_right_block">Basé :<input type="text" step="0.01"class="create_ressources right_block"></div>
            <div class="ressources_right_block">Semaine :<input type="text" step="0.01"class="create_ressources right_block"></div>
            <div class="ressources_right_block">Type d'appareils :<input type="text" step="0.01"class="create_ressources right_block"></div>

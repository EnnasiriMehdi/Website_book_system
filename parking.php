...
if (isset($_POST["change_state"]) && isset($_POST["id"]) && count($_POST)==2)
{
    ...
    $key = new parking($_POST["id"],"",1,"","","",$state);
...
if (isset($_POST["modif_ressources"]) && isset($_POST["id"]) && count($_POST)==2)
{
    ...
    $key = new parking($_POST["id"],$values[0],$values[1],$values[2],$values[3],$values[4],"");
...
if (isset($_POST["create_ressources"]) && count($_POST)==1)
{
    ...
    $key = new parking("",$values[0],$values[1],$values[2],$values[3],$values[4],0);
    echo $key ->create();
...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <div>
        <h1 class="h3 mb-4 text-gray-800 left_block">Parking</h1><div class="right_block col-10"> <button class="button" onclick="show_create_block()">Créer un parking</button></div>
    </div>
    ...
    <div>
        <div class="left_block col-6">
            <div>
                ...
                if (!empty($get_list))
                {
                    ...
                    echo                '<th>Prix HT</th>';
                    echo                '<th>TVA</th>';
                    echo                '<th>Espace disponible</th>';
                    echo                '<th>Espace maximal</th>';
                    echo                '<th>État</th>';
                    echo                '</tr>';
                    echo            '</thead>';
                    echo            '<tfoot>';
                    ...
                    foreach ($get_list as $res)
                    {
                        ...
                        echo                '<td>' . $res["VAT"] . '</td>';
                        echo                '<td>' . $res["available_area"] . '</td>';
                        echo                '<td>' . $res["max_area"] . '</td>';
        ...
        <div class="right_block col-6 half-ressources" id="info_block">
            ...
            <div class="ressources_right_block">Espace disponible :<p class = "display_infos right_block"></p></div>
            <div class="ressources_right_block">Espace maximal :<p class = "display_infos right_block"></p></div>
        ...
        <div class="right_block col-6 half-ressources" id="modif_block">
            ...
            <div class="ressources_right_block">Espace actuel :<input type="number" step="0.01"class="new_ressources right_block"></div>
            <div class="ressources_right_block">Espace maximal :<input type="number" step="0.01"class="new_ressources right_block"></div>
        ...
        <div class="right_block col-6 half-ressources" id="create_block">
            ...
            <div class="ressources_right_block">Espace actuel :<input type="number" step="0.01"class="create_ressources right_block"></div>
            <div class="ressources_right_block">Espace maximal :<input type="number" step="0.01"class="create_ressources right_block"></div>
